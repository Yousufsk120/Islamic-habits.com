...
(() => {
  ...
  const addStyle = () => {
    ...
    style.textContent = `
      ...
      .phone-mock{position:relative;z-index:2;min-height:390px;border:8px solid #07100e;border-radius:46px;padding:18px;overflow:hidden;background:#062f29;box-shadow:0 26px 60px rgba(0,0,0,.3),inset 0 0 0 1px rgba(246,242,232,.12)}
      ...
      .mock-map{height:100px;margin:20px -18px 10px;background:radial-gradient(circle at 28% 36%,rgba(255,207,107,.5),transparent 28px),radial-gradient(circle at 72% 42%,rgba(92,215,233,.55),transparent 52px),linear-gradient(135deg,#a7efd2,#5cd7e9 46%,#f6f2e8)}
      .mock-compass{position:relative;width:min(220px,72vw);height:min(220px,72vw);margin:0 auto;border:8px solid rgba(7,16,14,.78);border-radius:50%;background:repeating-conic-gradient(#111 0 1.5deg,transparent 1.5deg 8deg),#fff;box-shadow:0 0 44px rgba(100,238,181,.44)}
      ...
      .bead-line{position:absolute;top:135px;left:-16px;right:-16px;height:86px;transform:rotate(-12deg)}.bead-line i{display:inline-block;width:52px;height:52px;margin:0 4px;border-radius:50%;background:radial-gradient(circle at 32% 28%,rgba(246,242,232,.78),transparent 14%),radial-gradient(circle at 50% 50%,#0f9f61,#075634);box-shadow:0 7px 18px rgba(0,0,0,.28)}
